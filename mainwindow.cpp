	...
	: QMainWindow(parent)
{
	...
	editMenu->addAction(tr("Undo"), Qt::CTRL | Qt::Key_Z, [this] {
		// do nothing!
	});
	editMenu->addAction(tr("Redo"), Qt::CTRL | Qt::SHIFT | Qt::Key_Z, [this] {
		// do nothing!
	});
	editMenu->addSeparator();
	editMenu->addAction(tr("Cut"), Qt::CTRL | Qt::Key_X, [this] {
		// do nothing!
	});
	editMenu->addAction(tr("Copy"), Qt::CTRL | Qt::Key_C, [this] {
		// do nothing!
	});
	editMenu->addAction(tr("Paste"), Qt::CTRL | Qt::Key_V, [this] {
		// do nothing!
	});
	editMenu->addAction(tr("Delete"), Qt::Key_Delete, [this] {
		// do nothing!
	});
...
void MainWindow::AddProject(ProjectData* data)
{
	...
	projectTabHolder->addTab(new ProjectStageView(data, projectTabHolder), data->Title.c_str());
}
